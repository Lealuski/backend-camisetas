...
const URL = 'print-order'; //url del controlador de la api
const BULK = 'bulk'; //url del controlador de la api
const NAME = 'print-order'; //nombre de la api
...
export const createPrintOrders = async (data) => {
    try {
...
export const updatePrintOrder = async (id, data) => {
    try {
        const resp = await fetch(`${HOST}${URL}/${id}`, {
            method: 'PUT',
            headers: {
...
export const deletePrintOrderById = async (id) => {
    try {
        const resp = await fetch(`${HOST}${URL}/${id}`, {
            method: 'DELETE',
        });
...
export const deletePrintOrders = async () => {
    try {
        const resp = await fetch(`${HOST}${URL}`, {
            method: 'DELETE',
        });
